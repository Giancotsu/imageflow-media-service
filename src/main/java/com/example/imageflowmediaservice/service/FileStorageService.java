...
import com.example.imageflowmediaservice.exception.InvalidFileException;
import com.example.imageflowmediaservice.exception.StorageException;
    ...
    public ImageMetadata store(MultipartFile file, String username) {
        ...
        try {
            ...
            if (filename.contains("..")) {
                ...
                throw new InvalidFileNameException(filename, "Cannot store file with relative path outside current directory ");
            }
